...
return [
    ...
    'cancel_reason_id' => 'Причина отказа',
    'shop_comment' => 'Комментарий магазина',
    'user_comment' => 'Комментарий заказчика',
    'track_info' => 'Информация о посылке',
